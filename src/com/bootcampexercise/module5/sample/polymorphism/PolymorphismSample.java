package com.bootcampexercise.module5.sample.polymorphism;
...
//  object from person can call student method but no overload methods, only overriding
...
//		p.address("SanJose", "CA", 1234, "Pines St"); // calls address() method from the Student_P class
        ps.address("SanJose", "CA");  // calls address() method from the Person_P class
